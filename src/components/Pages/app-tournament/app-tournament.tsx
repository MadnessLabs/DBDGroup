        ...
        <ion-content>
          ...
          <ion-grid>
            ...
            <ion-row>
              <ion-col>
                <ion-card>
                  <ion-item><ion-badge color="primary">Survivor</ion-badge></ion-item>
                </ion-card>
              </ion-col>
              <ion-col>
                <ion-card>
                  <ion-item><ion-badge>Killer</ion-badge></ion-item>
                </ion-card>
              </ion-col>
            </ion-row>
            <ion-row>
              <ion-col>
                <ion-card>
                  <ion-item><ion-badge color="secondary">S1B</ion-badge><ion-badge color="medium" slot="end">Bloodpoints</ion-badge></ion-item>
                </ion-card>
              </ion-col>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">Kills</ion-badge><ion-badge color="medium" slot="end">NumberofKills</ion-badge></ion-item>
                </ion-card>
              </ion-col>
            </ion-row>
            <ion-row>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">S2B</ion-badge><ion-badge color="medium" slot="end">Bloodpoints</ion-badge></ion-item>
                </ion-card>
              </ion-col>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">Total Hooks</ion-badge><ion-badge color="medium" slot="end">#</ion-badge></ion-item>
                </ion-card>
              </ion-col>
            </ion-row>
            <ion-row>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">S3B</ion-badge><ion-badge color="medium" slot="end">Bloodpoints</ion-badge></ion-item>
                </ion-card>
              </ion-col>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">Gens Left</ion-badge><ion-badge color="medium" slot="end">#</ion-badge></ion-item>
                </ion-card>
              </ion-col>
            </ion-row>
            <ion-row>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">S4B</ion-badge><ion-badge color="medium" slot="end">Bloodpoints</ion-badge></ion-item>
                </ion-card>
              </ion-col>
              <ion-col>
                <ion-card>
                <ion-item><ion-badge color="secondary">Escapes</ion-badge><ion-badge color="medium" slot="end">#</ion-badge></ion-item>
                </ion-card>
              </ion-col>
            </ion-row>
          </ion-grid>
