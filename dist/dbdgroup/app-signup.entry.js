...
const appSignupCss = "ion-content{--background:url(\"/assets/images/my-background.jpg\") no-repeat bottom center /\r\n        cover}";
...
let AppSignup = class {
  ...
  render() {
    return (h("ion-content", null, h("form", null, h("ion-input", { type: "email", name: "email", value: " " }), h("ion-input", { type: "password", name: "password", value: " " }), h("ion-button", { type: "submit", color: "tertiary" }, "Submit")), h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("ion-card", null, h("ion-grid", null, h("ion-row", null, h("ion-col", null, "Survivor"), h("ion-col", null, "Killer")))))), h("ion-grid", null, h("ion-row", null, h("ion-col", null, h("ion-button", { expand: "block", href: "https://discord.gg/7VsNGcwAr6", target: "_blank" }, h("ion-icon", { name: "logo-discord", slot: "start" }), "Discord")), h("ion-col", null, h("ion-button", { expand: "block", href: "https://steamcommunity.com/profiles/76561198073470151/", target: "_blank" }, h("ion-icon", { name: "logo-steam", slot: "start" }), "Steam")), h("ion-col", null, h("ion-button", { expand: "block", onClick: (event) => this.presentToast(event), target: "_blank" }, h("ion-icon", { name: "help-circle", slot: "start" }), "Help")))))));
  }
};
