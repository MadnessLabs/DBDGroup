...
let AppHome = class {
  ...
  render() {
    ...
    return (h("ion-content", null, h("ion-grid", { class: "ion-no-padding" }, h("ion-row", { style: {
      ...
      } }, h("ion-col", { size: "8", "size-md": "2" }, h("ion-accordion-group", null, h("ion-accordion", { value: "colors", "toggle-icon": "arrow-down-circle" }, h("ion-item", { style: {
        "text-align": "center",
        ...
        "justify-content": "center",
      } }, h("ion-col", { size: "10", "size-md": "4", style: {
        "text-align": "center",
      } }, h("ion-card", { style: {
        opacity: ".6",
        "border-style": "ridge",
