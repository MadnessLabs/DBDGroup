...
import { r as registerVersion, E as ErrorFactory, F as FirebaseError, g as getApp, _ as _getProvider, a as _registerComponent, b as Component, L as Logger, c as calculateBackoffMillis, i as isIndexedDBAvailable, v as validateIndexedDBOpenable, d as isBrowserExtension, e as areCookiesEnabled, f as getModularInstance, h as deepEqual, j as LogLevel, S as SDK_VERSION, k as isMobileCordova, m as isReactNative, q as querystring, n as base64Decode, o as getUA, p as isIE, s as createSubscribe, t as querystringDecode, u as extractQuerystring, w as isEmpty, x as initializeApp, B as Ba, y as yh, C as Ca } from './index.esm-0dfa3272.js';
...
let AppRoot = class {
  ...
  render() {
    return (h("ion-router", { useHash: false }, h("ion-route", { url: "/", component: "app-home", componentProps: this.componentProps }), h("ion-route", { url: "/signup", component: "app-signup", componentProps: this.componentProps })));
  }
};
