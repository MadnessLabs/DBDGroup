...
let SelectTags = class {
        ...
        callbackOnCreateTemplates: (template) => {
          return {
            ...
            item: (classNames, data) => {
              return template(`
                      <ion-chip class="${classNames.item} ${data.highlighted
            ...
            choice: (classNames, data) => {
              return template(`
                      <ion-item class="${classNames.item} ${classNames.itemChoice} ${data.disabled
  ...
  render() {
    ...
    return (h("ion-item", { ref: (el) => (this.itemEl = el), lines: this.lines }, this.label && (h("ion-label", { position: this.labelPosition }, this.label)), h("select", { title: this.placeholder || this.name, disabled: this.disabled, multiple: this.multiple, name: this.name, required: this.required, ref: (el) => (this.choicesEl = el) }, h("slot", null), !this.multiple && this.placeholder ? (h(OptionEl, { placeholder: true }, this.placeholder)) : null, this.options.map((option) => (h("option", { selected: this.multiple
