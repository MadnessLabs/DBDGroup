...
let AppRoot = class {
  ...
  render() {
    return (index.h("ion-router", { useHash: false }, index.h("ion-route", { url: "/", component: "app-home", componentProps: this.componentProps }), index.h("ion-route", { url: "/signup", component: "app-signup", componentProps: this.componentProps })));
  }
};
