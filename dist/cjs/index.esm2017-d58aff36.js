...
const processEs6 = require('./process-es6-39ef8921.js');
const global = require('./global-9027a413.js');
...
function isNode() {
    try {
        return (Object.prototype.toString.call(global.global.process) === '[object process]');
    }
    catch (e) {
        return false;
    }
...
var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global.global !== 'undefined' ? global.global : typeof self !== 'undefined' ? self : {};
...
function O(t, ...e) {
    if (N.logLevel <= exports.LogLevel.DEBUG) {
        const n = e.map(B);
...
function F(t, ...e) {
    if (N.logLevel <= exports.LogLevel.ERROR) {
        const n = e.map(B);
 ...
 * @internal
 */ function $(t, ...e) {
    if (N.logLevel <= exports.LogLevel.WARN) {
        const n = e.map(B);
 ...
 */ class Ti {
     ...
     */    static St() {
        var t;
        return "undefined" != typeof processEs6.browser$1 && "YES" === (null === (t = processEs6.browser$1.env) || void 0 === t ? void 0 : t.Ct);
    }
...
/** Implements the steps for LRU garbage collection. */ class Mr {
    ...
    Nn(t, e) {
        ...
        this.removeOrphanedDocuments(t, n)))).next((t => {
            if (c = Date.now(), k() <= exports.LogLevel.DEBUG) {
 ...
 */ class eo {
    ...
    /** Returns all local documents matching the specified query. */    Qs(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.ei(e, i);
            return ($e(e) || Be(e)) && this.ni(e.limitType, r, s, n) ? this.ti(t, e) : (k() <= exports.LogLevel.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ze(e)), 
    ...
    ti(t, e) {
        return k() <= exports.LogLevel.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", ze(e)), 
