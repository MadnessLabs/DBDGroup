...
const Toggle = class {
  ...
  render() {
    return (index.h("ion-item", { lines: this.lines }, index.h("slot", { name: "start", slot: "start" }), this.label && index.h("ion-label", { position: this.labelPosition }, this.label), index.h("ion-toggle", { disabled: this.disabled, color: this.color, name: this.name, checked: !!this.value }), index.h("slot", { name: "end", slot: "after" })));
  }
};
Toggle.style = toggleCss;

exports.fireenjin_toggle = Toggle;
