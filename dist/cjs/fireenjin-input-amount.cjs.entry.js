...
const InputAmount = class {
  ...
  render() {
    return (index.h("ion-item", { lines: this.lines }, index.h("ion-icon", { name: "logo-usd", slot: "start" }), this.label && (index.h("ion-label", { position: this.labelPosition }, this.label)), this.presets && this.presets.length && (index.h("div", { class: "presets", slot: "end" }, this.presets.map((preset) => (index.h("span", { onClick: () => this.selectPreset(preset) }, typeof preset === "string"
      ? preset
      : (preset === null || preset === void 0 ? void 0 : preset.label)
        ? preset.label
        : (preset === null || preset === void 0 ? void 0 : preset.value)
          ? preset.value
          : ""))))), index.h("ion-input", { min: this.min, max: this.max, ref: (el) => (this.inputEl = el), disabled: this.disabled, inputmode: "decimal", type: "tel", step: this.step, placeholder: this.placeholder, required: this.required, autofocus: this.autofocus, value: this.formattedValue })));
  }
...
exports.fireenjin_input_amount = InputAmount;
