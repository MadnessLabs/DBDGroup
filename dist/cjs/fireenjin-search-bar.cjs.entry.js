...
const SearchBar = class {
  ...
  render() {
    var _a, _b, _c;
    return (index.h(index.Host, null, index.h("div", { class: "search-bar-wrapper" }, index.h("ion-searchbar", { disabled: this.disabled }), index.h("div", { class: "chip-bowl" }, this.showFilter &&
      ((_a = this.filters) === null || _a === void 0 ? void 0 : _a.length) &&
      this.filters.map((control) => {
        var _a, _b, _c, _d;
        return (index.h("ion-chip", { outline: !((_b = (_a = this.currentFilters) === null || _a === void 0 ? void 0 : _a[control === null || control === void 0 ? void 0 : control.name]) === null || _b === void 0 ? void 0 : _b.value), onClick: (event) => this.fireenjinTrigger.emit({
            event,
            name: "filter",
            payload: {
              control,
            },
          }) }, (control === null || control === void 0 ? void 0 : control.icon) && index.h("ion-icon", { name: control.icon }), (control === null || control === void 0 ? void 0 : control.label) && (index.h("ion-label", null, this.getControlLabel(control))), ((_d = (_c = this.currentFilters) === null || _c === void 0 ? void 0 : _c[control === null || control === void 0 ? void 0 : control.name]) === null || _d === void 0 ? void 0 : _d.value) && (index.h("ion-icon", { name: "close-circle", onClick: (event) => this.clearFilter(event, control) }))));
      }))), ((_b = this.filters) === null || _b === void 0 ? void 0 : _b.length) && (index.h("ion-button", { onClick: () => (this.showFilter = !this.showFilter), class: "filter-button", size: "small", fill: "clear", shape: "round", style: { color: "var(--ion-text-color)" } }, index.h("ion-icon", { name: "funnel", slot: "icon-only" }), ((_c = Object.keys(this.currentFilters)) === null || _c === void 0 ? void 0 : _c.length) && (index.h("ion-badge", { slot: "end" }, this.currentFilters
...
exports.fireenjin_search_bar = SearchBar;
