...
function O(t, ...e) {
    if (k.logLevel <= exports.LogLevel.DEBUG) {
        const n = e.map(L);
...
function M(t, ...e) {
    if (k.logLevel <= exports.LogLevel.ERROR) {
        const n = e.map(L);
 ...
 * @internal
 */ function F(t, ...e) {
    if (k.logLevel <= exports.LogLevel.WARN) {
        const n = e.map(L);
 ...
 */ class lr {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Ln(e, i);
            return (pe(e) || Te(e)) && this.Bn(e.limitType, r, s, n) ? this.Fn(t, e) : (x() <= exports.LogLevel.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Se(e)), 
    ...
    Fn(t, e) {
        return x() <= exports.LogLevel.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", Se(e)), 
