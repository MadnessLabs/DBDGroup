...
const index$1 = require('./index-faf70b2e.js');
...
const animation = require('./animation-7e91de82.js');
const index$2 = require('./index-af080b50.js');
const helpers = require('./helpers-061c1472.js');
const frameworkDelegate = require('./framework-delegate-378fd27f.js');
const index$3 = require('./index-dca7fbe4.js');
...
const Checkbox = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { onClick: this.onClick, "aria-labelledby": label ? labelId : null, "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, role: "checkbox", class: theme.createColorClasses(color, {
        [mode]: true,
        ...
        interactive: true,
      }) }, index$1.h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24", part: "container" }, path), index$1.h("label", { htmlFor: inputId }, labelText), index$1.h("input", { type: "checkbox", "aria-checked": `${checked}`, disabled: disabled, id: inputId, onFocus: () => this.onFocus(), onBlur: () => this.onBlur(), ref: (focusEl) => (this.focusEl = focusEl) })));
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
...
const Radio = class {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { "aria-checked": `${checked}`, "aria-hidden": disabled ? 'true' : null, "aria-labelledby": label ? labelId : null, role: "radio", tabindex: buttonTabindex, onFocus: this.onFocus, onBlur: this.onBlur, onClick: this.onClick, class: theme.createColorClasses(color, {
      ...
      }) }, index$1.h("div", { class: "radio-icon", part: "container" }, index$1.h("div", { class: "radio-inner", part: "mark" }), index$1.h("div", { class: "radio-ripple" })), index$1.h("label", { htmlFor: inputId }, labelText), index$1.h("input", { type: "radio", checked: checked, disabled: disabled, tabindex: "-1", id: inputId, ref: (nativeEl) => (this.nativeInput = nativeEl) })));
  }
  get el() { return index$1.getElement(this); }
  static get watchers() { return {
    "color": ["emitStyle"],
