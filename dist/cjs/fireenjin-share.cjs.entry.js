...
const Share = class {
  constructor(hostRef) {
    ...
    this.fireenjinShareClose = index.createEvent(this, "fireenjinShareClose", 7);
  }
  ...
  render() {
    return (index.h("ion-list", null, index.h("ion-item", { lines: this.lines, class: "share-twitter", onClick: (event) => this.openPopup(event, "twitter") }, index.h("ion-icon", { slot: "end", name: "logo-twitter" }), "Share on Twitter"), index.h("ion-item", { lines: this.lines, class: "share-facebook", onClick: (event) => this.openPopup(event, "facebook") }, index.h("ion-icon", { slot: "end", name: "logo-facebook" }), "Share on Facebook"), index.h("ion-item", { lines: this.lines, ref: (el) => (this.copyItemEl = el), class: "share-clipboard", "data-clipboard-text": this.url }, index.h("ion-icon", { slot: "end", name: "clipboard" }), "Copy to Clipboard")));
  }
};
Share.style = shareCss;

exports.fireenjin_share = Share;
