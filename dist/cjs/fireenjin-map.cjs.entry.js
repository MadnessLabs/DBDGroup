...
const index = require('./index-223acf5e.js');
...
var GeolocationOriginal = /** @class */ (function (_super) {
    ...
    GeolocationOriginal.prototype.getCurrentPosition = function (options) { return index.cordova(this, "getCurrentPosition", { "callbackOrder": "reverse" }, arguments); };
    /**
...
const Map = class {
  constructor(hostRef) {
    ...
    this.fireenjinTrigger = index$1.createEvent(this, "fireenjinTrigger", 7);
    /**
  ...
  async loadGoogleMaps(options) {
    const loader$1 = new loader.Loader(this.googleMapsKey, options || {});
    return loader$1.load();
  }
  async componentDidLoad() {
    var _a;
    if (!(index$1.Build === null || index$1.Build === void 0 ? void 0 : index$1.Build.isBrowser))
      return;
  ...
  render() {
    return (index$1.h(index$1.Host, { class: { "map-is-visible": this.isVisible } }, index$1.h("div", { id: "map" })));
  }
  get mapEl() { return index$1.getElement(this); }
