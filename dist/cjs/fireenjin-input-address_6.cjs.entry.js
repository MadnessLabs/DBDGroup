...
const loader = require('./loader-7137d6eb.js');
...
const InputAddress = class {
  constructor(hostRef) {
    ...
    this.fireenjinAddressMode = index.createEvent(this, "fireenjinAddressMode", 7);
    this.fireenjinUpdateAutoHeight = index.createEvent(this, "fireenjinUpdateAutoHeight", 7);
    /**
  ...
  async loadGoogleMaps(options) {
    const loader$1 = new loader.Loader(this.googleMapsKey, Object.assign({ libraries: ["places"] }, options));
  ...
  render() {
    ...
    return [
      index.h("ion-item", { lines: this.lines, class: { "is-hidden": !this.manualEntry } }, index.h("ion-label", { position: this.labelPosition }, this.label), index.h("div", { class: "manual-fields" }, index.h("ion-input", { ref: (el) => (this.streetInputEl = el), type: "text", name: this.name + ".street", placeholder: "Street Address", value: value.street, required: this.required && this.manualEntry }), index.h("ion-input", { ref: (el) => (this.unitInputEl = el), type: "text", name: this.name + ".unit", placeholder: "Street Address 2", value: value.unit }), index.h("ion-input", { ref: (el) => (this.cityInputEl = el), type: "text", name: this.name + ".city", placeholder: "City", value: value.city, required: this.required && this.manualEntry }), index.h("ion-grid", null, index.h("ion-row", null, index.h("ion-col", { size: "6" }, index.h("fireenjin-input-state", { ref: (el) => (this.stateSelectEl = el), name: this.name + ".state", value: value.state, placeholder: "State" })), index.h("ion-col", { size: "6" }, index.h("ion-input", { ref: (el) => (this.zipInputEl = el), class: "zip-input", type: "tel", name: this.name + ".zip", min: "0", max: "999999", value: value.zip, placeholder: "Zip Code", required: this.required && this.manualEntry }))))), index.h("ion-button", { fill: "clear", color: "primary", onClick: () => this.toggleManualEntry(), slot: "end" }, "Search")),
...
const InputFile = class {
  ...
  render() {
    return (index.h("ion-card", { disabled: this.disabled, class: { "drag-over": this.dragOver }, onDragEnter: (event) => this.onDragEnter(event), onDragOver: (event) => this.onDragOver(event), onDrag: (event) => this.onDrag(event), onDrop: (event) => this.onDrop(event), onDragLeave: (event) => this.onDragLeave(event), onClick: () => this.openFile() }, index.h("ion-item", { lines: "none" }, index.h("ion-icon", { name: this.icon ? this.icon : "document", slot: "start" }), index.h("div", null, index.h("h2", null, this.dragOver
      ...
      : this.defaultValue
        ? this.defaultValue
        : "Select a letterhead"))), index.h("input", { disabled: this.disabled, type: "file", onChange: (event) => this.selectFile(event), accept: this.accept ? this.accept : null, value: "blah" })));
  }
...
const Radios = class {
  ...
  render() {
    return (index.h("ion-list", null, index.h("ion-radio-group", { name: this.name, value: this.value, allowEmptySelection: this.allowEmptySelection }, index.h("ion-list-header", { position: this.labelPosition }, this.label), (this.options ? this.options : []).map((option) => this.optionEl ? (this.optionEl(option)) : (index.h("ion-item", { lines: this.lines }, index.h("ion-label", null, (option === null || option === void 0 ? void 0 : option.label) || (option === null || option === void 0 ? void 0 : option.value)), index.h("ion-radio", { mode: this.mode, color: (option === null || option === void 0 ? void 0 : option.color) || this.color, disabled: this.disabled || option.disabled, slot: (option === null || option === void 0 ? void 0 : option.slot) || this.radioSlot, value: (option === null || option === void 0 ? void 0 : option.value) || null })))), (this.results ? this.results : []).map((result) => this.optionEl ? (this.optionEl(result)) : (index.h("ion-item", { lines: this.lines }, index.h("ion-label", null, (result === null || result === void 0 ? void 0 : result.label) || (result === null || result === void 0 ? void 0 : result.name) || (result === null || result === void 0 ? void 0 : result.value) || (result === null || result === void 0 ? void 0 : result.id)), index.h("ion-radio", { mode: this.mode, color: (result === null || result === void 0 ? void 0 : result.color) || this.color, disabled: this.disabled || (result === null || result === void 0 ? void 0 : result.disabled), slot: (result === null || result === void 0 ? void 0 : result.slot) || this.radioSlot, value: (result === null || result === void 0 ? void 0 : result.value) || (result === null || result === void 0 ? void 0 : result.id) || null })))))));
  }
};
...
exports.fireenjin_input_address = InputAddress;
exports.fireenjin_input_file = InputFile;
exports.fireenjin_input_photo = InputPhoto;
exports.fireenjin_radios = Radios;
