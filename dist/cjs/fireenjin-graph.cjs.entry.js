...
const Graph = class {
  constructor(hostRef) {
    ...
    this.fireenjinGraphTooltip = index.createEvent(this, "fireenjinGraphTooltip", 7);
    this.fireenjinGraphClick = index.createEvent(this, "fireenjinGraphClick", 7);
    /**
  ...
  render() {
    this.refresh();
    return (index.h("div", { id: "graph-wrapper" }, index.h("canvas", null)));
  }
  get graphEl() { return index.getElement(this); }
};
Graph.style = graphCss;

exports.fireenjin_graph = Graph;
