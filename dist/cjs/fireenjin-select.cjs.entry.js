...
const Select = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("ion-item", { lines: this.lines }, this.icon && index.h("ion-icon", { slot: "start", name: this.icon }), this.label && (index.h("ion-label", { position: this.labelPosition }, this.label)), index.h("ion-select", { disabled: this.disabled, selectedText: this.selectedText, interface: this.interface, compareWith: this.compareWith, name: this.name, value: this.value, okText: this.okText, multiple: this.multiple, cancelText: this.cancelText, placeholder: this.placeholder, interfaceOptions: this.interfaceOptions
        ? this.interfaceOptions
        : {
          header: this.header,
