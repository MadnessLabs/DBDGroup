import { r as registerInstance, h, H as Host, a as getElement, c as createEvent } from './index-47739846.js';
import { r as registerVersion, _ as _registerComponent, C as Component, a as _getProvider, E as ErrorFactory, F as FirebaseError, g as getApp, b as getModularInstance, d as deepEqual, L as Logger, i as isBrowserExtension, c as isIndexedDBAvailable, v as validateIndexedDBOpenable, e as areCookiesEnabled, f as calculateBackoffMillis, h as isMobileCordova, j as isReactNative, S as SDK_VERSION, k as createSubscribe, q as querystringDecode, l as extractQuerystring, m as getUA, n as LogLevel, o as querystring, p as base64Decode, s as isIE, t as isEmpty, u as initializeApp, B as Ba, y as yh, w as Ca } from './index.esm2017-ebdc6632.js';
import { g as getIonMode, c as config, a as isPlatform } from './ionic-global-9868b782.js';
import { c as componentOnReady, d as debounce } from './helpers-d9e8a9eb.js';
import { g as getTimeGivenProgression } from './cubic-bezier-ed243a9b.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-2b7f1eb9.js';
import { t as transition } from './index-4934cd58.js';
  ...
  async componentWillLoad() {
    ...
    onAuthStateChanged(auth, async (session) => {
      if (session === null || session === void 0 ? void 0 : session.uid) {
        ...
        await yh(Ca(db, `users/${session.uid}`), {
          id: session.uid,
        }, {
          merge: true,
        });
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-8b28b98b.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-33533c24.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-33c4d6e4.js').then(module => module.startInputShims(config));
        }
...
let RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./swipe-back-6995fa38.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
...
export { AppRoot as dbdgroup_router, App as ion_app, Route as ion_route, Router as ion_router, RouterOutlet as ion_router_outlet };
