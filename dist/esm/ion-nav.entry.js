import { r as registerInstance, d as createEvent, h, c as getElement } from './index-4531603b.js';
...
import { k as assert, s as shallowEqualStringMap } from './helpers-fa85189e.js';
import { l as lifecycle, t as transition, s as setPageHidden, L as LIFECYCLE_WILL_UNLOAD, a as LIFECYCLE_WILL_LEAVE, b as LIFECYCLE_DID_LEAVE } from './index-3a35b6e4.js';
import { a as attachComponent } from './framework-delegate-0db1edfd.js';
...
const Nav = class {
  ...
  async componentDidLoad() {
    this.rootChanged();
    this.gesture = (await import('./swipe-back-918c8eef.js')).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
