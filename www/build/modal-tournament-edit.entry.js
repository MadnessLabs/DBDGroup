...
const ModalTournamentEdit = class {
  ...
  render() {
    ...
    return [
      ...
      h("ion-content", { class: "ion-padding" }, h("ion-card", null, h("fireenjin-form", { resetButtonColor: "warning", resetButton: "DELETE", endpoint: "tournaments", documentId: this.tournamentId }, h("fireenjin-input", { labelPosition: "stacked", name: "name", label: "Tournament Name", value: (_a = this.tournament) === null || _a === void 0 ? void 0 : _a.name }), h("fireenjin-input", { labelPosition: "stacked", name: "id", label: "id", value: (_b = this.tournament) === null || _b === void 0 ? void 0 : _b.id }), h("fireenjin-select-tags", { labelPosition: "stacked", "data-fill": true, name: "rules", label: "Rules", value: ((_c = this.tournament) === null || _c === void 0 ? void 0 : _c.rules) || [], options: [
          {
            label: "No Items",
            value: "no items",
          },
