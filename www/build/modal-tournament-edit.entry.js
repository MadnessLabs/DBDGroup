...
const ModalTournamentEdit = class {
  ...
  render() {
    ...
    return [
      ...
      h("ion-content", { class: "ion-padding" }, h("ion-card", null, h("fireenjin-form", { endpoint: "tournaments", documentId: this.tournamentId }, h("fireenjin-input", { labelPosition: "stacked", name: "name", label: "Tournament Name", value: (_a = this.tournament) === null || _a === void 0 ? void 0 : _a.name }), h("fireenjin-select", { labelPosition: "stacked", "data-fill": true, multiple: true, name: "rules", label: "Rules", value: ((_b = this.tournament) === null || _b === void 0 ? void 0 : _b.rules) || [], options: [
          {
            label: "No Items",
            value: "no items",
          },
