...
X$1.prototype.getResponseText=X$1.prototype.ga;X$1.prototype.send=X$1.prototype.ea;var createWebChannelTransport = esm.createWebChannelTransport=function(){return new Td};var getStatEventTarget = esm.getStatEventTarget=function(){return Sb()};var ErrorCode = esm.ErrorCode=Wb;var EventType = esm.EventType=Xb;var Event = esm.Event=H$1;var Stat = esm.Stat={rb:0,ub:1,vb:2,Ob:3,Tb:4,Qb:5,Rb:6,Pb:7,Nb:8,Sb:9,PROXY:10,NOPROXY:11,Lb:12,Hb:13,Ib:14,Gb:15,Jb:16,Kb:17,nb:18,mb:19,ob:20};var FetchXmlHttpFactory = esm.FetchXmlHttpFactory=pd;var WebChannel = esm.WebChannel=$b;
var XhrIo = esm.XhrIo=X$1;
...
export { el as $, deepCopy as A, base64Encode as B, Component as C, stringLength as D, ErrorFactory as E, FirebaseError as F, Deferred as G, safeGet as H, isAdmin as I, isValidFormat as J, assertionError as K, Logger as L, map as M, errorPrefix as N, createMockUserToken as O, initializeApp as P, Sc as Q, Dc as R, SDK_VERSION as S, Tc as T, wc as U, Nc as V, ll as W, hl as X, pc as Y, rl as Z, _getProvider as _, al as a, cl as a0, fl as a1, kh as a2, Oh as a3, $h as a4, xh as a5, LogLevel as b, isMobileCordova as c, deepEqual as d, isReactNative as e, base64Decode as f, getModularInstance as g, getUA as h, isBrowserExtension as i, isIE as j, createSubscribe as k, querystringDecode as l, extractQuerystring as m, isEmpty as n, _registerComponent as o, getApp as p, querystring as q, registerVersion as r, stringify as s, jsonEval as t, contains as u, stringToByteArray as v, Sha1 as w, base64 as x, assert as y, isNodeSdk as z };
