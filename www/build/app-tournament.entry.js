...
const AppTournament = class {
  ...
  render() {
    ...
    return (h(Host, null, h("ion-header", null, h("ion-toolbar", { color: "light" }, h("ion-buttons", { slot: "start" }, h("ion-button", { href: "/", color: "primary" }, h("ion-icon", { name: "arrow-back", color: "primary" }))), h("ion-title", null, "Tournament Page"), h("ion-buttons", { slot: "end" }, h("ion-button", { color: "primary", onClick: () => this.dbdModalOpen.emit({
        ...
        "text-align": "center",
        margin: "0 auto",
      } }, h("ion-title", null, "Dead by Daylight Tournament Signup"), h("fireenjin-input", { labelPosition: "stacked", name: "name", label: "Name", value: (_d = this.user) === null || _d === void 0 ? void 0 : _d.name }), h("fireenjin-input", { labelPosition: "stacked", name: "email", label: "E-mail", value: (_e = this.user) === null || _e === void 0 ? void 0 : _e.email }), h("fireenjin-input", { labelPosition: "stacked", name: "discordId", label: "Discord Username", value: (_f = this.user) === null || _f === void 0 ? void 0 : _f.discordId }), h("fireenjin-input", { labelPosition: "stacked", name: "steamId", label: "Steam Code", value: (_g = this.user) === null || _g === void 0 ? void 0 : _g.steamId }), h("fireenjin-select", { labelPosition: "stacked", "data-fill": true, name: "enteringAs", label: "Entering as?", value: (_h = this.user) === null || _h === void 0 ? void 0 : _h.enteringAs, options: [
        {
          label: "Survivor",
          value: "enteringAs",
        },
