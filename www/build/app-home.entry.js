...
const AppHome = class {
  ...
  render() {
    var _a, _b;
    return [
      h("ion-header", null, h("ion-toolbar", { color: "light" }, h("ion-buttons", null, h("ion-button", null, "Login")), h("ion-buttons", { slot: "end" }, h("ion-button", { color: "primary", href: "https://deadbydaylight.group/user/someone" }, h("ion-title", null, "Edit"), h("ion-icon", { slot: "end", color: "primary", name: "person" }))), h("ion-title", null, "Dead By Daylight Group"))),
